...
with outflow as 
(select paid_by, sum(amount) as outcash from
Transactions group by paid_by),
inflow as 
(select paid_to, sum(amount) as incash from
Transactions group by paid_to)

select u.user_id, u.user_name, credit-ifnull(o.outcash, 0)+ifnull(i.incash, 0) as credit,
if (credit-ifnull(o.outcash, 0)+ifnull(i.incash, 0) < 0, 'Yes', 'No') as credit_limit_breached
from Users u
left join outflow o
