...
left join 
(
select customer_id, order_id, order_date, row_number() over(partition by customer_id order by order_date desc) as order_rank
from Orders ) t 
on c.customer_id = t.customer_id
where t.order_rank  <=3
order by customer_name asc, t.customer_id asc, t.order_date desc
